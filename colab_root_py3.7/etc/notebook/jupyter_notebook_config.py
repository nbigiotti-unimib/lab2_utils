...
if 'JSROOTSYS' in os.environ:
    ...
    c.NotebookApp.extra_static_paths.append(os.path.join("/home/nicobigio01/colab_root/output/colab_root_py3.7", "js"))
    c.ServerApp.extra_static_paths.append(os.path.join("/home/nicobigio01/colab_root/output/colab_root_py3.7", "js"))
