...
namespace ROOT {
   ...
   {
      return GenerateInitInstanceLocal((::TFumili*)nullptr);
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const ::TFumili*)nullptr); R__UseDummy(_R__UNIQUE_DICT_(Init));
...
namespace ROOT {
   ...
   {
      return GenerateInitInstanceLocal((::TFumiliMinimizer*)nullptr);
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const ::TFumiliMinimizer*)nullptr); R__UseDummy(_R__UNIQUE_DICT_(Init));
} // end of namespace ROOT
