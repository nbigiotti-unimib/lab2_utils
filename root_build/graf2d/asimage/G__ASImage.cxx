...
namespace ROOT {
   ...
   {
      return GenerateInitInstanceLocal((::TASImage*)nullptr);
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const ::TASImage*)nullptr); R__UseDummy(_R__UNIQUE_DICT_(Init));
...
namespace ROOT {
   ...
   {
      return GenerateInitInstanceLocal((::TASImagePlugin*)nullptr);
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const ::TASImagePlugin*)nullptr); R__UseDummy(_R__UNIQUE_DICT_(Init));
} // end of namespace ROOT
...
namespace ROOT {
   ...
   {
      return GenerateInitInstanceLocal((::TASPluginGS*)nullptr);
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const ::TASPluginGS*)nullptr); R__UseDummy(_R__UNIQUE_DICT_(Init));
} // end of namespace ROOT
