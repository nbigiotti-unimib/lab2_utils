...
namespace ROOT {
   ...
   {
      ::TGX11TTF *ptr = nullptr;
      static ::TVirtualIsAProxy* isa_proxy = new ::TInstrumentedIsAProxy< ::TGX11TTF >(nullptr);
   ...
   {
      return GenerateInitInstanceLocal((::TGX11TTF*)nullptr);
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const ::TGX11TTF*)nullptr); R__UseDummy(_R__UNIQUE_DICT_(Init));
} // end of namespace ROOT

//______________________________________________________________________________
atomic_TClass_ptr TGX11TTF::fgIsA(nullptr);  // static to hold class pointer
...
{
   return ::ROOT::GenerateInitInstanceLocal((const ::TGX11TTF*)nullptr)->GetImplFileName();
}

//______________________________________________________________________________
int TGX11TTF::ImplFileLine()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::TGX11TTF*)nullptr)->GetImplFileLine();
}

//______________________________________________________________________________
TClass *TGX11TTF::Dictionary()
{
   fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TGX11TTF*)nullptr)->GetClass();
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TGX11TTF*)nullptr)->GetClass(); }
   return fgIsA;
}
