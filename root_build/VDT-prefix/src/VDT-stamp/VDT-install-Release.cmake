...
set(stdout_log "/home/nicobigio01/colab_root/root_build/VDT-prefix/src/VDT-stamp/VDT-install-out.log")
set(stderr_log "/home/nicobigio01/colab_root/root_build/VDT-prefix/src/VDT-stamp/VDT-install-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /home/nicobigio01/colab_root/root_build/VDT-prefix/src/VDT-stamp/VDT-install-*.log")
  endif()
  ...
  set(msg "VDT install command succeeded.  See also /home/nicobigio01/colab_root/root_build/VDT-prefix/src/VDT-stamp/VDT-install-*.log")
  message(STATUS "${msg}")
endif()
