...
set(stdout_log "/home/nicobigio01/colab_root/root_build/LZMA-prefix/src/LZMA-stamp/LZMA-build-out.log")
set(stderr_log "/home/nicobigio01/colab_root/root_build/LZMA-prefix/src/LZMA-stamp/LZMA-build-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /home/nicobigio01/colab_root/root_build/LZMA-prefix/src/LZMA-stamp/LZMA-build-*.log")
  endif()
  ...
  set(msg "LZMA build command succeeded.  See also /home/nicobigio01/colab_root/root_build/LZMA-prefix/src/LZMA-stamp/LZMA-build-*.log")
  message(STATUS "${msg}")
endif()
