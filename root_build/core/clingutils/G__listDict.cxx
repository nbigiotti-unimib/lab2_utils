...
namespace ROOT {
   ...
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const list<void*>*)nullptr); R__UseDummy(_R__UNIQUE_DICT_(Init));

   // Dictionary for non-ClassDef classes
   static TClass *listlEvoidmUgR_Dictionary() {
      TClass* theClass =::ROOT::GenerateInitInstanceLocal((const list<void*>*)nullptr)->GetClass();
...
namespace ROOT {
   ...
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const list<long>*)nullptr); R__UseDummy(_R__UNIQUE_DICT_(Init));

   // Dictionary for non-ClassDef classes
   static TClass *listlElonggR_Dictionary() {
      TClass* theClass =::ROOT::GenerateInitInstanceLocal((const list<long>*)nullptr)->GetClass();
...
namespace ROOT {
   ...
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const list<int>*)nullptr); R__UseDummy(_R__UNIQUE_DICT_(Init));

   // Dictionary for non-ClassDef classes
   static TClass *listlEintgR_Dictionary() {
      TClass* theClass =::ROOT::GenerateInitInstanceLocal((const list<int>*)nullptr)->GetClass();
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const list<float>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("list<float>", -2, "list", 552,
   ...
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const list<float>*)nullptr); R__UseDummy(_R__UNIQUE_DICT_(Init));

   // Dictionary for non-ClassDef classes
   static TClass *listlEfloatgR_Dictionary() {
      TClass* theClass =::ROOT::GenerateInitInstanceLocal((const list<float>*)nullptr)->GetClass();
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const list<double>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("list<double>", -2, "list", 552,
   ...
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const list<double>*)nullptr); R__UseDummy(_R__UNIQUE_DICT_(Init));

   // Dictionary for non-ClassDef classes
   static TClass *listlEdoublegR_Dictionary() {
      TClass* theClass =::ROOT::GenerateInitInstanceLocal((const list<double>*)nullptr)->GetClass();
...
namespace ROOT {
   ...
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const list<char*>*)nullptr); R__UseDummy(_R__UNIQUE_DICT_(Init));

   // Dictionary for non-ClassDef classes
   static TClass *listlEcharmUgR_Dictionary() {
      TClass* theClass =::ROOT::GenerateInitInstanceLocal((const list<char*>*)nullptr)->GetClass();
