...
namespace ROOT {
   ...
   {
      return GenerateInitInstanceLocal((::TRint*)nullptr);
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const ::TRint*)nullptr); R__UseDummy(_R__UNIQUE_DICT_(Init));
...
namespace ROOT {
   ...
   {
      return GenerateInitInstanceLocal((::TTabCom*)nullptr);
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const ::TTabCom*)nullptr); R__UseDummy(_R__UNIQUE_DICT_(Init));
} // end of namespace ROOT
